...
import { Key, KeyRound, Hash, Shield, Lock, FileKey, Smartphone } from 'lucide-react';
...
export const securityTools: Integration[] = [
    {
        ...
        color: '#34495E',
        tags: ['RSA', '키', '암호화', '비대칭'],
        related: ['public-key-extractor', 'aes-encryptor'],
    },
    {
        ...
        color: '#2C3E50',
        tags: ['공개키', 'RSA', 'PEM', '추출'],
        related: ['rsa-key-generator', 'aes-encryptor'],
    },
    {
        id: 'hash-tool',
        name: '해시 생성기',
