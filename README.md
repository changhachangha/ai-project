...
> 사이트를 처음 쓴다면 [**사용 가이드**](docs/사용법.md)부터 보세요.
...
-   [**사용 가이드**](docs/사용법.md) — 사이트를 쓰는 방법 (도구 찾기 · 사용 · 즐겨찾기 · 설정)
...
-   **사용 가이드 추가**: `docs/사용법.md` — 도구 찾기·사용 흐름·즐겨찾기·설정·단축키·FAQ
-   **버그 수정**: ⌘K 검색 창이 하드코딩된 더미 목록과 존재하지 않는 경로(`/tools/*`)로 이동해 **모든 항목이 404**가 되던 문제 수정
